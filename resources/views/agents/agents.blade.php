                            ...
                            @foreach ($agents as $agent)
                                <tr id="event_id_{{ $agent->id }}">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="javascript:void(0)" id="convert" data-id="{{ $agent->id }}" data-user="{{ $agent->user_name }}">
                                            <span class="badge bg-warning p-2">COMMISSION OUT</span>
                                        </a>
                                    </td>
                                </tr>
                            @endforeach
      ...
      $('body').on('click', '#edit-player', function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#curr_commission').val(number_format(response[0][0].commission_percent * 100, 2));  
    ...
    if ($("#playerForm").length > 0) {
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                ...
                type: "GET",
                data: {playerId:playerId,currComm:currComm,playerStatus:playerStatus},
                success: function (response) {
                    location.reload();
                },
                error: function (response) {
